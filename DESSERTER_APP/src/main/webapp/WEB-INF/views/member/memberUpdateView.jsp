		...
		<section id="container">
			<form id="updateForm" action="/member/memberUpdate" method="post">
				...
				<div class="form-group has-feedback">
					...
					<input class="form-control" type="text" id="userBirth" name="userBirth" value="${member.userBirth}"/>
				</div>
				<div class="form-group has-feedback">
					<label class="control-label" for="userGender">성별</label>
					<input class="form-control" type="text" id="userGender" name="userGender" value="${member.userGender}"/>
				</div>
			</form>
				<div class="form-group has-feedback">
