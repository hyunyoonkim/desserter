		...
		<form action="/member/memberDelete" method="post" id="delForm">
			...
			<div class="form-group has-feedback">
				<label class="control-label" for="userBirth">생년월일</label> <input
					class="form-control" type="text" id="userBirth" name="userBirth"
					value="${member.userBirth}" readonly="readonly" />
			</div>
			<div class="form-group has-feedback">
				<label class="control-label" for="userGender">성별</label> <input
					class="form-control" type="text" id="userGender" name="userGender"
					value="${member.userGender}" readonly="readonly" />
			</div>
		</form>
		<div class="form-group has-feedback">
